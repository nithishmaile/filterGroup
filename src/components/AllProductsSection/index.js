...
class AllProductsSection extends Component {
  state = {
    ...
    searchInputValue: '',
    activeRatingId: '',
    apiUrlStatus: apiStatus.initial,
  }
  ...
  getProducts = async () => {
    this.setState({
      apiUrlStatus: apiStatus.inProgress,
    })
    ...
    if (response.ok) {
      ...
      this.setState({
        ...
        apiUrlStatus: apiStatus.success,
      })
    } else {
      this.setState({apiUrlStatus: apiStatus.failure})
    }
  }
  ...
  render() {
    const {activeCategoryId, activeRatingId, searchInputValue} = this.state
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          changeRating={this.updateRating}
          searchInputValue={searchInputValue}
          changeSearchInputValue={this.updateSearchInputValue}
